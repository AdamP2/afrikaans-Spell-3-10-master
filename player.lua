...
function scene:show( event )
    ...
    elseif phase == "did" then
		...
		local function addPlayer(event)
			...
			back:addEventListener("tap",block)
			sceneGroup:insert(back)
      local nuweSpelerGroup = display.newGroup()
			local options =
			{
				--parent = row,
				text = "Kies jou graad",
			...
			nuweSpelerTitle = display.newText( options )
			nuweSpelerTitle.anchorX =0.5
			nuweSpelerTitle.anchorY =0
			nuweSpelerTitle.alpha = 1
			nuweSpelerTitle.x = display.contentWidth  / 2
			nuweSpelerTitle.y = yInset
			nuweSpelerTitle:setFillColor( 0 )
			nuweSpelerGroup:insert(nuweSpelerTitle)
			local curOption = nil
			...
			option1.gr = 3
			nuweSpelerGroup:insert(option1)
			curOption = option1
			...
			option1Text = display.newText( options )
			option1Text.anchorX =0.5
			option1Text.anchorY =0
			option1Text.alpha = 1
			option1Text.x = xInset*3.5
			option1Text.y = yInset * 3 + option1Text.contentHeight / 4
			option1Text:setFillColor(1)
			nuweSpelerGroup:insert(option1Text)
			local option2 = display.newRoundedRect(xInset*6.5 + 10,yInset * 3,xInset*3,yInset*2,4)
			option2.anchorX = 0.5
			option2.anchorY = 0
			option2:setFillColor( 0.7)
			option2.gr = 4
			nuweSpelerGroup:insert(option2)
			...
			option2Text = display.newText( options )
			option2Text.anchorX =0.5
			option2Text.anchorY =0
			option2Text.alpha = 1
			option2Text.x = xInset*6.5 + 10
			option2Text.y = yInset * 3 + option2Text.contentHeight / 4
			option2Text:setFillColor(1)
			nuweSpelerGroup:insert(option2Text)
			local option3 = display.newRoundedRect(xInset*9.5 + 20,yInset * 3,xInset*3,yInset*2,4)
			option3.anchorX = 0.5
			option3.anchorY = 0
			option3:setFillColor( 0.7)
			option3.gr = 5
			nuweSpelerGroup:insert(option3)
			...
			option3Text = display.newText( options )
			option3Text.anchorX =0.5
			option3Text.anchorY =0
			option3Text.alpha = 1
			option3Text.x = xInset*9.5 + 20
			option3Text.y = yInset * 3 + option3Text.contentHeight / 4
			option3Text:setFillColor(1)
			nuweSpelerGroup:insert(option3Text)
			local option4 = display.newRoundedRect(xInset*12.5 + 30,yInset * 3,xInset*3,yInset*2,4)
			option4.anchorX = 0.5
			option4.anchorY = 0
			option4:setFillColor( 0.7)
			option4.gr = 6
			nuweSpelerGroup:insert(option4)
			...
			option4Text = display.newText( options )
			option4Text.anchorX =0.5
			option4Text.anchorY =0
			option4Text.alpha = 1
			option4Text.x = xInset*12.5 + 30
			option4Text.y = yInset * 3 + option4Text.contentHeight / 4
			option4Text:setFillColor(1)
			nuweSpelerGroup:insert(option4Text)
			local option5 = display.newRoundedRect(xInset*15.5 + 40,yInset * 3,xInset*3,yInset*2,4)
			option5.anchorX = 0.5
			option5.anchorY = 0
			option5:setFillColor( 0.7)
			option5.gr = 7
			nuweSpelerGroup:insert(option5)
			...
			option5Text = display.newText( options )
			option5Text.anchorX =0.5
			option5Text.anchorY =0
			option5Text.alpha = 1
			option5Text.x = xInset*15.5 + 40
			option5Text.y = yInset * 3 + option5Text.contentHeight / 4
			option5Text:setFillColor(1)
			nuweSpelerGroup:insert(option5Text)
			...
			nuweSpelerGroup:insert(customeTextbox)
			local options =
			{
				--parent = row,
			...
			customeText = display.newText( options )
			customeText.anchorX =0.5
			customeText.anchorY =0
			customeText.alpha = 1
			customeText.x = display.contentWidth  / 2
			customeText.y = display.contentHeight - yInset*14 + 10
			customeText:setFillColor( 0, 0, 0,0.5 )
			nuweSpelerGroup:insert(customeText)
				 ...
				 if(event.phase == "began")then
					if(event.key == "del")then
						...
						if(counter>1)then
							...
							customeText.text = wordTyped
						end
					elseif(event.key == "ok")then
						--Use myText------------------------------------
						if(customeText.text~="Jou speler naam")then
							local val = {}
							val.name =customeText.text
